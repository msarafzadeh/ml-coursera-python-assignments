...
def plotData(X, y):
    ...
    pos = y == 1
    neg = y == 0
    pyplot.plot(X[pos, 0], X[pos, 1], 'b*', lw=2,
                ms=10)  # all first elements where the corresponding y is positive, all second elements where the corresponding y is positive
